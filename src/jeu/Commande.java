...
public enum Commande {
	NORD("N", "N (Aller ра la sortie Nord)"),
	NORD_EST("NE", "NE (Aller ра la sortie Nord-EST)"), 
	SUD("S", "S (Aller ра la sortie Sud)"), 
	EST("E", "E (Aller ра la sortie Est)"), 
	OUEST("O", "O (Aller ра la sortie Ouest)"), 
	AIDE("?", "? (Aide)"), 
	QUITTER("Q", "Q (Quitter)");
