...
public class Game implements java.io.Serializable {
	...
	private KeyElement key = new KeyElement(0, 0, 32, 32, "check_icon.png", "key"); //‡ modifier par la bonne image/nom
	...
	private void createMap() {
		...
		zones[3] = new Zone("CafÈtÈria", "CafÈtÈria.png", 588, 42);
	...
	private void showHelp() {
		...
		gui.show();
		gui.show("Les commandes autoris√©es sont :");
		gui.show();
	...
	private void goTo(String direction) {
		...
		if (newZone == null) {
			...
			gui.show(currentZone.longDescription());
			gui.show();
			// Cr√©e et affiche le personnage √† la zone de spawn de la salle.
	...
	//MÈthode permettant d'afficher les diffÈrents Èlements sur la carte (KeyElement & Npc).
	 ...
	 * dans une liste.
	 * 
	 * @param direction La sortie √† inverser.
	 * @return String vide.
	 */
	...
	/**
	 * Une methode qui permet de recuperer la derniere salle visit√© par le joueur.
	 * 
